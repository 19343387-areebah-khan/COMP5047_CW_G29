...
**(a) approval of USU membership applications** submitted by university-specific student unions (FR-UO-1 explains the details for the data required for an application to the USU membership).

Approval of union membership means:

1. the union's registration data will be stored in the system and used for communication with the union and its student members  
2. union officers as recorded in the registration data will get access to the system as Union Officers  
3. the union’s account becomes active, so students at the university will be able to register to the system as student member users and obtain access to the system  
4. events organised by the union are promoted on the USU system  
5. the union can participate in nation-wide events organised by the USU  

**(b) Approval of updates of USU registration data**

- the system should provide a facility to the USU to review and approve the request of changes to its data  

**(c) Approval of termination of USU membership**

- the system should provide a facility to USU staff to review and approve requests of termination of USU membership submitted by a university-specific student union  
- receiving this request implies the union's account becomes inactive =  
  1. no new student members of the university will be registered to the system  
  2. updates to the union's events and other information will be stopped  
  3. the union's participation in USU events is not allowed  
- approval of termination implies  
  1. the union's account remains inactive for 1 month  
  2. after 1 month, the data of the union is removed from the system. Union officers' accounts are removed from the system with all data deleted. Student members of the union are removed from the system with all data deleted.  
